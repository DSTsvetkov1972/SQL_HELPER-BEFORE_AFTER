conditions = {
    ...
    'svod_table_name': 'audit.avoperevozki_soispolniteli_iz_rks',
    
    'container_field': 'SHAPKA.№ контейнера_cleaned',
    
    'order_id_field': 'SHAPKA.№ заказа',
    
    'date_field': 'Дата для анализа',
    ...
    'where_conditions':
        [
        "service_provision_place_filial_name='НКП МСК' AND",
